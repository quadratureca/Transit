...
public class Burlington : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Position.Burlington running at: {time}", DateTimeOffset.Now);

            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    //string burlington = "https://navburl-burlington.opendata.arcgis.com/documents/ffb7ad2131114bd49ff3149bc16e362b/explore";
                    string burlington = "https://opendata.burlington.ca/gtfs-rt/GTFS_VehiclePositions.pb";
                    //try
                    //{
